...
ControlToCvPlugin::ControlToCvPlugin(HostControl host_control) : InternalPlugin(host_control)
{
    ...
    _send_velocity_parameter = register_bool_parameter("send_velocity", "Send Velocity", "", false, true);
    _send_modulation_parameter = register_bool_parameter("send_modulation", "Send Modulation", "", false, true);
    _retrigger_mode_parameter = register_bool_parameter("retrigger_enabled", "Retrigger enabled", "", false, true);
