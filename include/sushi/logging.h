...
#define SUSHI_INITIALIZE_LOGGER(FILE_NAME, LOGGER_NAME, MIN_LOG_LEVEL, ENABLE_FLUSH_INTERVAL, LOG_FLUSH_INTERVAL, SENTRY_CRASH_HANDLER_PATH, SENTRY_DSN) SUSHI_LOG_ERROR_CODE_OK
