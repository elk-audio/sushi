...
public:
    ...
    virtual ~SushiControlService() = default;
     ...
     grpc::Status GetParameterValueUnNormalized(grpc::ServerContext* context, const sushi_rpc::ParameterIdentifier* request, sushi_rpc::GenericFloatValue* response) override;
