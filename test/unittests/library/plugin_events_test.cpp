...
TEST (TestPluginEvents, TestFactoryFunction)
{
    ...
    EXPECT_EQ(123, note_on_event.processor_id());
    ...
    EXPECT_EQ(122, note_off_event.processor_id());
    ...
    EXPECT_EQ(124, note_at_event.processor_id());
    ...
    EXPECT_EQ(125, pc_event.processor_id());
    EXPECT_EQ(4, pc_event.sample_offset());
    EXPECT_EQ(64, pc_event.param_id());
    ...
    EXPECT_EQ(126, wm_event.processor_id());
    ...
    EXPECT_EQ(127, spc_event.processor_id());
    EXPECT_EQ(6, spc_event.sample_offset());
    EXPECT_EQ(65, spc_event.param_id());
    ...
    EXPECT_EQ(128, dpc_event.processor_id());
    EXPECT_EQ(7, dpc_event.sample_offset());
    EXPECT_EQ(66, dpc_event.param_id());
