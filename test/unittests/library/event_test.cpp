...
{
    auto note_on_event = KeyboardEvent(KeyboardEvent::Subtype::NOTE_ON, 1, 48, 1.0f, PROCESS_NOW);
    EXPECT_TRUE(note_on_event.is_keyboard_event());
    EXPECT_TRUE(note_on_event.maps_to_rt_event());
    EXPECT_EQ(PROCESS_NOW, note_on_event.time());
    ...
    auto note_off_event = KeyboardEvent(KeyboardEvent::Subtype::NOTE_OFF, 1, 48, 1.0f, PROCESS_NOW);
    ...
    auto note_at_event = KeyboardEvent(KeyboardEvent::Subtype::NOTE_AFTERTOUCH, 1, 48, 1.0f, PROCESS_NOW);
    ...
    auto pitchbend_event = KeyboardEvent(KeyboardEvent::Subtype::PITCH_BEND, 2, 0.5f, PROCESS_NOW);
    ...
    auto modulation_event = KeyboardEvent(KeyboardEvent::Subtype::MODULATION, 3, 1.0f, PROCESS_NOW);
    ...
    auto aftertouch_event = KeyboardEvent(KeyboardEvent::Subtype::AFTERTOUCH, 4, 1.0f, PROCESS_NOW);
    ...
    auto midi_event = KeyboardEvent(KeyboardEvent::Subtype::WRAPPED_MIDI, 5, {1,2,3,4}, PROCESS_NOW);
    ...
    auto param_ch_event = ParameterChangeEvent(ParameterChangeEvent::Subtype::FLOAT_PARAMETER_CHANGE, 6, 50, 1.0f, PROCESS_NOW);
    ...
    auto string_pro_ch_event = StringPropertyChangeEvent(7, 51, "Hello", PROCESS_NOW);
    ...
    auto data_pro_ch_event = DataPropertyChangeEvent(8, 52, testdata, PROCESS_NOW);
    ...
    auto async_comp_not = AsynchronousProcessorWorkCompletionEvent(123, 9, 53, PROCESS_NOW);
...
TEST(EventTest, TestFromRtEvent)
{
    ...
    Event* event = Event::from_rt_event(note_on_event, PROCESS_NOW);
    ...
    event = Event::from_rt_event(note_off_event, PROCESS_NOW);
    ASSERT_TRUE(event != nullptr);
    EXPECT_TRUE(event->is_keyboard_event());
    EXPECT_EQ(PROCESS_NOW, event->time());
    ...
    event = Event::from_rt_event(note_at_event, PROCESS_NOW);
    ASSERT_TRUE(event != nullptr);
    EXPECT_TRUE(event->is_keyboard_event());
    EXPECT_EQ(PROCESS_NOW, event->time());
    kb_event = static_cast<KeyboardEvent*>(event);
    ...
    event = Event::from_rt_event(mod_event, PROCESS_NOW);
    ASSERT_TRUE(event != nullptr);
    EXPECT_TRUE(event->is_keyboard_event());
    EXPECT_EQ(PROCESS_NOW, event->time());
    kb_event = static_cast<KeyboardEvent*>(event);
    ...
    event = Event::from_rt_event(pb_event, PROCESS_NOW);
    ASSERT_TRUE(event != nullptr);
    EXPECT_TRUE(event->is_keyboard_event());
    EXPECT_EQ(PROCESS_NOW, event->time());
    kb_event = static_cast<KeyboardEvent*>(event);
    ...
    event = Event::from_rt_event(at_event, PROCESS_NOW);
    ASSERT_TRUE(event != nullptr);
    EXPECT_TRUE(event->is_keyboard_event());
    EXPECT_EQ(PROCESS_NOW, event->time());
    kb_event = static_cast<KeyboardEvent*>(event);
    ...
    event = Event::from_rt_event(midi_event, PROCESS_NOW);
    ASSERT_TRUE(event != nullptr);
    EXPECT_TRUE(event->is_keyboard_event());
    EXPECT_EQ(PROCESS_NOW, event->time());
    kb_event = static_cast<KeyboardEvent*>(event);
    ...
    event = Event::from_rt_event(async_work_event, PROCESS_NOW);
    ASSERT_TRUE(event != nullptr);
    ...
    event = Event::from_rt_event(async_blod_del_event, PROCESS_NOW);
    ASSERT_TRUE(event != nullptr);
    EXPECT_TRUE(event->is_async_work_event());
    EXPECT_TRUE(event->process_asynchronously());
    delete event;
