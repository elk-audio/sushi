...
Sushi carries most dependencies as submodules and will build and link with them automatically. A couple of dependencies are not included however and must be provided or installed system-wide. See the list below:
  ...
  * gRPC - Can either be installed with packages libgrpc++-dev, libprotobuf-dev, and protobuf-compiler or installed from source and installed system wide. See [https://github.com/grpc/grpc/blob/master/src/cpp/README.md] for instructions. Current gRPC version in sushi is 1.14.1 and current protobuf version 3.6.1. Other versions can't be guaranteed to work.
