...
options.reactive_audio_inputs  = 10; // e.g. Bela Gem Multi
...
See `examples/bela_gem_multi_host.cpp` for a complete 10-in / 10-out Reactive host targeting the Bela Gem Multi hardware.
